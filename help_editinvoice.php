...
<body>
  ...
  <div class="container">
      <p class="lead">Welcome to the Help Menu for Editing an Invoice. <br>
     ...
     There are 15 data fields listed on the Edit Invoice page that require specific inputs in order to successfully submit a invoice into your database. The invoice data is prepopulated with the customer information you selected to edit.
     Please edit the fields as needed and ensure the required fields have data. The requirements for each field are listed below<br>
     <br><lg>&diamond;First Name: The customers first name is a required field as indicated by the asterisk. Please enter the customers first name
      ...
      <br><lg>&diamond;Job Status: The job status is a required field as indicated by the asterisk. Please enter the job status<br></br>



      <p class="lead">
     Once the required information has been entered, please select the green button for "Update"
     OR select "Cancel" to exit the screen.<br></br>

     An additional option available on this screen is the ability to Delete a customer that is a red button to indicate the danger of doing so. Please be sure the invoice data is no longer needed in the system before deleting invoice information as this information is utilized for profitability
