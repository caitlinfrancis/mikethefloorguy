...
<body>
  ...
  <div class="container">
      <p class="lead">Welcome to the Help Menu for Editing an Customer. <br>
        ...
        There are 9 data fields listed on the Edit Invoice page that require specific inputs in order to successfully submit a customer into your database. The customer data is prepopulated with the customers information.
     ...
     There are 9 data fields listed on the Edit page that require specific inputs in order to successfully submit a customer into your database. Please update only the required fields.<br>
