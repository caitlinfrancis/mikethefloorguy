...
<body>
  ...
  <div class="container">
      <p class="lead">Welcome to the Help Menu for Adding a Customer. <br>
     ...
     There are 9 data fields listed on the Add Customer page that require specific inputs in order to successfully submit a customer into your database.<br>
     <br><lg>&diamond;First Name: The customers first name is a required field as indicated by the asterisk. Please enter the customers first name
      ...
      <br> <lg>&diamond;Company: Adding a company is not a requirement</br><br></br>


      <p class="lead">
     Once the required information has been entered, please select the green button for "Add Customer"
